        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/<?php echo $root_directory ?>/page1.php">Services</a></li>
                    <li><a href="/<?php echo $root_directory ?>/page2.php">About Us</a></li>
                    <li><a href="/<?php echo $root_directory ?>/page3.php">Contact Us</a></li>
                </ul>
